...
import CourseSearchBar from "@/components/CourseSearchBar"; // 👈 Import reusable bar
...
export default function HomePage() {
  ...
  const courseTypeImages: Record<string, string> = {
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-zinc-100 dark:from-zinc-900 dark:to-zinc-950">
      <div className="max-w-6xl mx-auto px-4 py-10 space-y-12">
        ...
        <CourseSearchBar
          ...
          courseTypeImages={courseTypeImages}
        />
      </div>
